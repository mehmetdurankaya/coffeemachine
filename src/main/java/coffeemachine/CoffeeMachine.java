...
import java.util.Scanner;
        ...
        public class CofeeMake {
            public static void main(String[] args) {
                ...
                do{//kahve makinesi oluşturuluyor.
                    System.out.println("**********Menu**********\n"
                            ...
                            +"5- Mocha\n"
                            +"6- Cappuccino");
                    System.out.print("Kahve seçiminizi yapınız: ");
                    select=input.nextInt();

                    switch(select){
                        case 1:
                            System.out.println("Seçiminiz: Türk Kahvesi");
                            break;
                        case 2:
                            System.out.println("Seçiminiz: Filitre Kahve");
                            break;
                        case 3:
                            System.out.println("Seçiminiz: Expresso");
                            break;
                        case 4:
                            System.out.println("Seçiminiz: Americano");
                            break;
                        case 5:
                            System.out.println("Seçiminz: Mocha");
                            break;
                        case 6:
                            System.out.println("Seçiminiz: Cappuccino");
                            break;
                        default:
